<div class="container" >
  <h1 class="text-center">ngx-simple-modal demo ng5</h1>
  <br>
  <br>
  <div class="row">
  ...
  <div class="row">
    <div class="col-sm-4 text-right">
      <b>Show modal from modal: </b>
    </div>
    <div class="col-sm-4">
      <button class="btn btn-default btn-block" (click)=showParentDialog()>Show modal</button>
    </div>
  </div>
</div>
